...
var _request = require('postman-request');

function request(uri, options) {
  return new Promise(function (resolve, reject) {
    _request(uri, options, function (err, httpResponse) {
      if (err) {
        reject(err);
      } else {
...
var JiraApi = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(JiraApi, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                ...
                throw new Error(JSON.stringify(_context.t0));
    ...
    key: "getSprint",
    value: function getSprint(sprintId) {
    ...
    value: function deleteRemoteLink(issueNumber, id) {
      return this.doRequest(this.makeRequestHeader(this.makeUri({
    ...
    value: function getMembersOfGroup(groupname) {
      var startAt = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      var maxResults = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 50;
      var includeInactiveUsers = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
      return this.doRequest(this.makeRequestHeader(this.makeUri({
    ...
    key: "updateWorklog",
    value: function updateWorklog(issueId, worklogId, body) {
      return this.doRequest(this.makeRequestHeader(this.makeUri({
        pathname: "/issue/".concat(issueId, "/worklog/").concat(worklogId)
      }), {
        method: 'PUT',
    ...
    value: function getBoardIssuesForSprint(boardId, sprintId) {
      ...
      var validateQuery = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : true;
      var fields = arguments.length > 6 ? arguments[6] : undefined;
      var expand = arguments.length > 7 ? arguments[7] : undefined;
      return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
    ...
    key: "genericAgileGet",
    value: function genericAgileGet(endpoint) {
      return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
        pathname: "/".concat(endpoint)
      })));
    }
